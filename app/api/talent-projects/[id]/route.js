...
export async function PUT(request, { params }) {
  try {
    ...
    if (body.cycleWindowStart !== undefined) data.cycleWindowStart = body.cycleWindowStart != null ? Number(body.cycleWindowStart) : null
    if (body.cycleWindowEnd   !== undefined) data.cycleWindowEnd   = body.cycleWindowEnd   != null ? Number(body.cycleWindowEnd)   : null
